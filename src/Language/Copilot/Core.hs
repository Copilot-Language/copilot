...
-- | A stream.
data Strm α = Show α => Strm (Buff α) (Expr__ α)

-- | A trigger.
data Trig = forall α . Typed α => Trig Name (Expr__ Bool) (Expr__ α)
...
-- | A handy short-hand for universally quantified expressions.
