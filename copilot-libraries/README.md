...
incorporated in a project, or as a standalone application. The C99 and Bluespec
backends ensures that the output is constant in memory and time, making it
suitable for systems with hard realtime requirements.
