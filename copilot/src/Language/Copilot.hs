...
-- interpreted for testing, or translated into code to be incorporated in a
-- project, or as a standalone application. The C99 and Bluespec backend output
...
-- together with one of the backend modules. At present, two backends are
-- available:
--
-- * "Copilot.Compile.C99" from the
--   <https://hackage.haskell.org/package/copilot-c99 copilot-c99> library.
--
-- * "Copilot.Compile.Bluespec" from the
--   <https://hackage.haskell.org/package/copilot-bluespec copilot-bluespec>
--   library.
